...
GRANT USAGE ON SCHEMA northwind TO anon, authenticated, service_role;
GRANT ALL ON ALL TABLES IN SCHEMA northwind TO anon, authenticated, service_role;
GRANT ALL ON ALL SEQUENCES IN SCHEMA northwind TO anon, authenticated, service_role;
GRANT ALL ON ALL ROUTINES IN SCHEMA northwind TO anon, authenticated, service_role;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA northwind GRANT ALL ON TABLES TO anon, authenticated, service_role;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA northwind GRANT ALL ON SEQUENCES TO anon, authenticated, service_role;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA northwind GRANT ALL ON ROUTINES TO anon, authenticated, service_role;
...
ALTER TABLE customer_customer_demo ENABLE ROW LEVEL SECURITY;
ALTER TABLE customer_demographics  ENABLE ROW LEVEL SECURITY;
ALTER TABLE customers              ENABLE ROW LEVEL SECURITY;
ALTER TABLE employees              ENABLE ROW LEVEL SECURITY;
ALTER TABLE employee_territories   ENABLE ROW LEVEL SECURITY;
